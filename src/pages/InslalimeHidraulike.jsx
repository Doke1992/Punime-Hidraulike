...
export default function InstalimeHidraulike() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        <nav className="text-sm text-gray-500 mb-8">
          ...
          <span className="text-[#0B3A66]">Instalime hidraulike në Tiranë</span>
        </nav>

        <h1 className="text-3xl md:text-4xl font-extrabold text-[#0B3A66] mb-6">
          Instalime hidraulike në Tiranë
        </h1>

        <p className="text-gray-700 leading-relaxed mb-4">
          Realizojmë instalime hidraulike për ambiente të reja ose rikonstruksione.
          Shërbimet përfshijnë instalime për banjo, kuzhina, tubacione, lavamana,
          dushe, wc dhe lidhje të sistemeve të ujit. Punimet kryhen me kujdes dhe
          me materiale të përshtatshme sipas nevojës së klientit.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          Kontaktoni Hidrauliku Im për ofertë dhe planifikim të instalimeve tuaja.
        </p>

        <div className="bg-[#EAF3FB] rounded-2xl p-6 mb-10">
          <h2 className="text-lg font-bold text-[#0B3A66] mb-4">Instalime që ofrojmë</h2>
          <ul className="space-y-2 text-gray-700 text-sm list-disc list-inside">
            <li>Instalime të plota hidraulike banjo dhe kuzhina</li>
            <li>Instalim tubacionesh për ndërtesa të reja</li>
            <li>Instalim lavamani, wc dhe dushi</li>
            <li>Lidhje sistemesh të ujit të ngrohtë dhe të ftohtë</li>
            <li>Instalim bojlerash dhe sistemeve të ngrohjes</li>
            <li>Instalime për rikonstruksione dhe rinovime</li>
          </ul>
        </div>
